...
def myNet():
    ...
    s2 = net.addSwitch( 's2', listenPort=6633, mac='00:00:00:00:00:02' )
    s3 = net.addSwitch( 's3', listenPort=6633, mac='00:00:00:00:00:03' )
    s4 = net.addSwitch( 's4', listenPort=6633, mac='00:00:00:00:00:04' )
